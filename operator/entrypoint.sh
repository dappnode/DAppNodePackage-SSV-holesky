...
assign_execution_endpoint() {
  ...
  "holesky-nethermind.dnp.dappnode.eth")
    EXECUTION_LAYER_WS="ws://holesky-nethermind.dappnode:8546"
    ;;
  "holesky-besu.dnp.dappnode.eth")
    EXECUTION_LAYER_WS="ws://holesky-besu.dappnode:8546"
    ;;
  "holesky-erigon.dnp.dappnode.eth")
    EXECUTION_LAYER_WS="ws://holesky-erigon.dappnode:8545"
    ;;
  *)
    echo "[ERROR] Unknown value for _DAPPNODE_GLOBAL_EXECUTION_CLIENT_HOLESKY. Please confirm that the value is correct."
    exit 1
    ;;
  esac
...
assign_beacon_endpoint() {
  ...
  "prysm-holesky.dnp.dappnode.eth")
    BEACON_NODE_API="http://beacon-chain.prysm-holesky.dappnode:3500"
    ;;
  "teku-holesky.dnp.dappnode.eth")
    BEACON_NODE_API="http://beacon-chain.teku-holesky.dappnode:3500"
    ;;
  "lighthouse-holesky.dnp.dappnode.eth")
    BEACON_NODE_API="http://beacon-chain.lighthouse-holesky.dappnode:3500"
    ;;
  "nimbus-holesky.dnp.dappnode.eth")
    BEACON_NODE_API="http://beacon-validator.nimbus-holesky.dappnode:4500"
    ;;
  "lodestar-holesky.dnp.dappnode.eth")
    BEACON_NODE_API="http://beacon-chain.lodestar-holesky.dappnode:3500"
    ;;
  *)
    echo "[ERROR] Unknown value for _DAPPNODE_GLOBAL_CONSENSUS_CLIENT_HOLESKY. Please confirm that the value is correct."
    exit 1
    ;;
  esac
